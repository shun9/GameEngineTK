...
#include "Player\States\DefenseState.h"
#include "Player\States\LongRangeAttackState.h"
...
void Game::OnDeviceLost()
{
	...
	DefenseState::DeleteInstance();
	LongRangeAttackState::DeleteInstance();
	MovingState::DeleteInstance();
	ShortRangeAttackState::DeleteInstance();
	StandingState::DeleteInstance();
